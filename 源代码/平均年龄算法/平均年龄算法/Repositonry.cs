...
namespace 平均年龄算法
{
   public  class Repositonry
    {
        /// <summary>
        /// 初始化一组人员数据
        /// </summary>
        /// <returns></returns>
        public static Calculatedaverage InitialPersonList()
        {
            var persons = new Calculatedaverage();
        ...
        /// <returns></returns>
        public static List<string> GetProvinces(Calculatedaverage persons)
        {
        ...
        /// <returns></returns>
        public static string AverageAge(Calculatedaverage persons)
        {
            var result = "";
